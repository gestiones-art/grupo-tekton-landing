  ...
  return (
    <main className="min-h-screen bg-gray-100 text-gray-900">
      ...
      <section className="max-w-4xl mx-auto p-6 leading-relaxed">
        <p>
          En <strong>Grupo Téktón</strong> realizamos el <strong>conforme a obra</strong> para dejar
          regularizada la documentación construida respecto del plano aprobado. Incluye
          relevamiento en sitio, actualización de planos, visado profesional y
          <strong> archivo del plano final</strong> ante el municipio.
        </p>
      </section>
      ...
      <section className="max-w-3xl mx-auto bg-white shadow-md rounded-2xl p-6 border mb-8">
        ...
        <ul className="list-disc pl-6 space-y-1 text-gray-700">
          <li>
            <strong>Plano en formato DWG</strong> (municipal) con el relevamiento final, firmado por
            profesional matriculado.
          </li>
          <li>
            <strong>Relevamiento del inmueble</strong> (mediciones y verificación de superficies).
          </li>
          <li>
          ...
          <li>
            <strong>Fotografías</strong> del estado actual (fachada e interiores).
          </li>
          <li>
            <strong>Memoria descriptiva</strong> de diferencias respecto del plano aprobado, si las hubiera.
          </li>
          <li>
