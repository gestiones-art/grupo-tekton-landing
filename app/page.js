...
<div className="grid gap-4" id="servicios">
  <div className="grid sm:grid-cols-2 gap-4">
    <Link href="/tramites/demolicion" className="rounded-2xl border p-5 hover:bg-gray-50 transition block">
    ...
    <Link href="/tramites/construccion" className="rounded-2xl border p-5 hover:bg-gray-50 transition block">
  ...
  <div className="grid sm:grid-cols-2 gap-4">
    <Link href="/tramites/conforme-obra" className="rounded-2xl border p-5 hover:bg-gray-50 transition block">
    ...
    <Link href="/tramites/electromecanica-ascensor" className="rounded-2xl border p-5 hover:bg-gray-50 transition block">
  ...
  <div className="grid sm:grid-cols-2 gap-4">
    <Link href="/tramites/subdivision-ph" className="rounded-2xl border p-5 hover:bg-gray-50 transition block">
    ...
    <Link href="/tramites/impacto-ambiental" className="rounded-2xl border p-5 hover:bg-gray-50 transition block">
