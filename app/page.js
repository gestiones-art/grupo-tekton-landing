        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg text-gray-700">
              <strong>Gestionamos</strong> permisos de construcción, demoliciones, conforme a obra y
              regularizaciones en Zona Norte. Enfocamos el trabajo en{" "}
              <strong>mejorar procesos</strong> para minimizar observaciones y{" "}
              <strong>optimizar tiempos administrativos</strong>, siempre con estricto cumplimiento
              normativo.
            </p>
